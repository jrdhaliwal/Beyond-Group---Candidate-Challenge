...
function App() {
  ...
  const labourCost =
    Number(workers) * Number(days) * Number(hoursPerDay) * 40 * 1.2;
  ...
  const fixedCost =
    PPE + proportionerMaintenance + miscConsumables + overheadAllocation;
  ...
  return (
    <div>
      ...
      >
        <img src="logo.png" alt="Beyond Group" style={{ height: "50px", marginBottom: "15px" }} />
        <h1>Foam Bid Calculator</h1>
      </div>
          ...
          <table style={{ borderCollapse: "collapse" }}>
            <tbody>
              ...
              <tr>
                ...
                <td className="checkbox" style={{ paddingBottom: "4px" }}>
                  <input
                    type="checkbox"
          ...
          <table style={{ borderCollapse: "collapse" }}>
            <tbody>
              ...
              <tr>
                ...
                {isContingency ? (
                  <td style={{ textAlign: "right" }}>
                    ${fmt(subtotalContingent)}
                  </td>
                ) : (
                  <td style={{ textAlign: "right" }}>
                    ${fmt(subtotalNonContingent)}
                  </td>
                )}
              </tr>
              <tr>
              ...
              <tr>
                ...
                {isContingency ? (
                  <td style={{ textAlign: "right" }}>
                    <strong>${fmt(grandTotalC)}</strong>
                  </td>
                ) : (
                  <td style={{ textAlign: "right" }}>
                    <strong>${fmt(grandTotalN)}</strong>
                  </td>
                )}
              </tr>
            </tbody>
